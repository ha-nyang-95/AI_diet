...
class PaymentLog(Base):
    ...
    __table_args__ = (
        ...
        # Toss/Stripe paymentKey dedup. NULL 미포함 partial UNIQUE — 결제 실패(키 부재)
        # row는 색인 미진입(자유 INSERT). Story 6.3 webhook 멱등화 forward-compat.
        Index(
            "idx_payment_logs_provider_payment_key_unique",
            "provider",
