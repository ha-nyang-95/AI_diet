...
export const metadata = {
  title: "Automated Decision Consent — BalanceNote",
};

export default async function AutomatedDecisionPageEn() {
  const doc = await fetchLegalDocument("automated-decision", "en");
  if (!doc) notFound();
